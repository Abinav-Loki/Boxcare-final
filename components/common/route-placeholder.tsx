  ...
  return (
    <section className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-5 py-10">
      <div className="rounded-lg border border-boxcare-border bg-white p-6 shadow-sm">
        <p className="text-sm font-semibold uppercase tracking-wide text-boxcare-orange">
          {owner}
        </p>
        <h1 className="mt-2 text-3xl font-bold text-boxcare-charcoal">
          {title}
        </h1>
      ...
      {checklist.length > 0 ? (
        <div className="rounded-lg border border-boxcare-border bg-boxcare-beige p-6">
          <h2 className="text-lg font-semibold text-boxcare-charcoal">
            First tasks
          </h2>
